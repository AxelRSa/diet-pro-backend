...
export const login = async (req: Request, res: Response) => {
  try {
    ...
    /* Comparing the password that the user sent with the password that is stored in the database, sign and get the token */
...
export const getUser = async (req: Request, res: Response) => {
  try {
    ...
    if (decodedToken === null) { throw new Error('There is an problem with authentication, try again') }
